<template>
  ...
  <r-space inline>
    ...
    <r-button type="primary" rightIcon="m-icon-calendar">日历</r-button>
    <r-button type="danger" leftIcon="m-icon-upload">上传</r-button>
  ...
  <r-space inline>
    ...
    <r-button type="primary" round leftIcon="m-icon-collection"></r-button>
    <r-button type="danger" round leftIcon="m-icon-calendar"></r-button>
  </r-space>
</template>
